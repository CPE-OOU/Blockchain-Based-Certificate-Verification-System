  ...
  return (
    <>
        ...
        <div className="container">
          <main className="nk-pages nk-pages-centered px-0 text-center">
            <header className="pt-5">
              <Link to="/" className="d-inline-block logo-lg">
              ...
              <div className="row justify-content-center">
                <div className="col-xl-6 col-md-7 col-sm-9">
                  ...
                  <div className="piller-two"><img src="images/piler-b.png" alt="graphic" /></div> */}
                    ...
                    <Link to="/" className="btn btn-grad btn-md btn-round">
                      Back to home
                    </Link>
                  </div>
                </div>
            ...
            <footer className="pb-5">
              <p className="copyright-text copyright-text-s3">
                Designed and Developed for Olabisi Onabanjo University
              </p>
            </footer>
          </main>
        </div>
      ...
      <div className="preloader" style={{ display: "none" }}>
        <span
          className="spinner spinner-round load-done"
          style={{ display: "none" }}
        ></span>
      </div>
    </>
